<div class="bs-docs-section">
    ...
    <p class="lead">Bootstrap is released under the MIT license and is copyright {{ site.time | date: "%Y" }} Twitter.
                    Boiled down to smaller chunks, it can be described with the following conditions.</p>
    ...
    <ul>
        <li>Freely download and use Bootstrap, in whole or in part, for personal, private, company internal, or
            commercial purposes
        </li>
    ...
    <ul>
        ...
        <li>Use any marks owned by Twitter in any way that might state or imply that you created the Twitter software in
            question
        </li>
    </ul>
    ...
    <p>The full Bootstrap license is located <a href="{{ site.repo }}/blob/master/LICENSE">in the project repository</a>
